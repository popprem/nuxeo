...
public class AboveDocumentJsonEnricher extends AbstractJsonEnricher<DocumentModel> {

    public static final String NAME = "aboveDocument";

    public AboveDocumentJsonEnricher() {
        super(NAME);
    }
    ...
    public void write(JsonGenerator jg, DocumentModel document) throws IOException {
        ...
        try (SessionWrapper wrapper = ctx.getSession(document)) {
            ...
            DocumentModel above = Framework.getService(TrashService.class).getAboveDocument(document, info.rootPaths);
