...
import org.nuxeo.ecm.platform.web.common.requestcontroller.filter.NuxeoCsrfFilter;
...
@LogCaptureFeature.FilterOn(logLevel = "WARN", loggerName = TestNuxeoCsrfFilter.LOGGER_NAME)
public class TestNuxeoCsrfFilter {

    protected static final String LOGGER_NAME = "org.nuxeo.ecm.platform.web.common.requestcontroller.filter.NuxeoCsrfFilter";
    ...
    protected NuxeoCsrfFilter filter;
    ...
    public void testMismatchPost() throws Exception {
        ...
        assertEquals("CSRF check failure: source: http://attacker.com does not match target: http://example.com:8080/",
                warn);
    }
